...
// Needs adjustment when using as modal: 
// function coverEyes() {
...
// 	TweenMax.to(armL, 1.35, {rotation: 0, ease: Quad.easeOut, delay: .1});
// 	TweenMax.to(armR, 1.35, {y: 220, ease: Quad.easeOut});
// 	TweenMax.to(armR, 1.35, {rotation: 0, ease: Quad.easeOut, delay: .3, onComplete: function() {
